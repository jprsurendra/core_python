...
USER_NAME = "surendrarathore.s@gmail.com"
PASSWORD = "ssr.rathore@39"
...
class TvDatafeed:
    ...
    def __create_df(raw_data, symbol):
        try:
            ...
            # data.to_csv("HDFC_BANK_001.csv", index=False)
    ...
    def get_hist(
        ...
        while True:
            ...
            if "series_completed" in result:
                break
        # print("symbol: ", symbol, "     raw_data: ", raw_data)
...
if __name__ == "__main__":
    ...
    data = tv.get_hist(
        "HDFCBANK",
        "NSE",
        interval=Interval.in_daily,   #Interval.in_1_hour,
        n_bars=500,
        extended_session=False,
    )
    data.to_csv("HDFC_BANK_003.csv")
    print(data)
